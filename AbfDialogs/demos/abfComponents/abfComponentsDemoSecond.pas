...
// Second form of application.
  ...
  // TabfColorPicker
    ...
    grpCP: TGroupBox;
      ...
      pnCPColor: TPanel;
  // abfFileAssociation
    abfFileAssociation: TabfFileAssociation;
    grpFA: TGroupBox;
      imgFA: TImage;
      lbFAInfo: TLabel;
      lbFAExtension: TLabel;
        edFAExtansion: TEdit;
      lbFALargeIcon: TLabel;
        imgFALargeIcon: TabfImage;
      lbFASmallIcon: TLabel;
      imgFASmallIcon: TabfImage;
      lbFAFileDescription: TLabel;
        edFAFileDescription: TEdit;
      lbFAOpenCommand: TLabel;
        edFAOpenCommand: TEdit;
  // Non-visual
    pmMain: TPopupMenu;
...
procedure TfrmComponentsDemoSecond.FormDestroy(Sender: TObject);
begin
  abfThreadTimer.Enabled := False;
end;
...
begin
  case (Sender as TComponent).Tag of
    ...
    5: abfComponentAboutEx(abfFileAssociation, '', '', True);
  end;
end;
